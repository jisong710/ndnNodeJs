...
var DEFAULT_RSA_PRIVATE_KEY_DER = new Buffer([
    ...
    0xcb, 0xea, 0x8f
        ...
        function encode(){
            ...
            validator = new Validator(new ValidationPolicyFromPib(keyChain.getPib()));
            ...
            keyChain.sign(data, function(signeddata) {
        ...
        function decode(){
            ...
            if (Log.LOG>3) console.log('DATA PACKET DECODED');
            if (Log.LOG>3) console.log(data);
            ...
            validator.validate
              (data,
               ...
               function(data, error) {
                 output+= "<br/>SIGNATURE INVALID. Reason: " + error.getInfo() + "<br/>";
                 document.getElementById('result').innerHTML = output;
               });
        }
