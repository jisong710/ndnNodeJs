...
<head>
    ...
    <script type="text/javascript">
        function encode() {
            ...
            interest.getForwardingHint().add(1, new Name("/A"));
        ...
        function decode() {
            ...
            if (Log.LOG>3) console.log('INTEREST DECODED');
            if (Log.LOG>3) console.log(interest);
            ...
            if (interest.getForwardingHint().size() > 0) {
              output += "forwardingHint:" + "<br/>";
              for (var i = 0; i < interest.getForwardingHint().size(); ++i)
                output += "&nbsp;&nbsp;Preference: " +
                  interest.getForwardingHint().get(i).getPreference() + ", Name: " +
                  interest.getForwardingHint().get(i).getName().toUri() + "<br/>";
            }
            else
              output += "forwardingHint: <none>" + "<br/>";
